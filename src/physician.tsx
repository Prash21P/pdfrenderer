   ...
   <script>   
    function save(lang) {   
       ...
       // console.log("+++langgg");
        ...
        fetch("http://localhost:3090/renderpdf?templateName=Physician&locale="+lang, {
            method: "POST",
            mode: "cors",
            headers: {
        ...
        <div class="container">
            ...
            <div class="row margin-top">
                <div class="col open-sans">
                 <h4 class="backgroundColor">${i18next.t( lang + ':ASSAY_DESCRIPTION')}</h4>
                    <div class="open-sans">
            ...
            <div class="row margin-top">
                ...
                <div class="row margin-top">
                    <div class="col open-sans">
                        <h4 class="backgroundColor">${i18next.t( lang + ':CRITERIA_FOR_DEFINING_DOMINANT_SEQUENCES')} </h4>
                        <div class="open-sans"> 
                        <ul>
            ...
            <div class="row">
                <div class="col">
            <input type="button" value="Save" onclick="save('${lang}'.toString())" class="save-css" > 
                </div>   
            </div>
          </div>
         </div>
