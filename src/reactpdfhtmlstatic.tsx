...
import {TemplateData} from "./reactpdfhtml";
...
export function renderStaticPDF() {
    return ReactPDF.renderToStream(<Document><Page size="A4"><Html>{html3}</Html></Page></Document>);
}
